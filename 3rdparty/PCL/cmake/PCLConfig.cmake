...
macro(find_boost)
  ...
  elseif(NOT BOOST_INCLUDEDIR)
    set(BOOST_INCLUDEDIR "C:/Program Files/Boost/include/boost-1_64")
...
macro(find_qhull)
  ...
  elseif(NOT QHULL_ROOT)
    get_filename_component(QHULL_ROOT "C:/Program Files/qhull/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    get_filename_component(FLANN_ROOT "C:/Program Files/flann/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  if(PKG_CONFIG_FOUND)
...
macro(find_VTK)
  if(PCL_ALL_IN_ONE_INSTALLER AND NOT ANDROID)
    if(EXISTS "${PCL_ROOT}/3rdParty/VTK/lib/cmake")
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/cmake/vtk-8.0" CACHE PATH "The directory containing VTKConfig.cmake")
    else()
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/vtk-8.0" CACHE PATH "The directory containing VTKConfig.cmake")
    endif()
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "C:/Program Files/VTK/lib/cmake/vtk-8.0" CACHE PATH "The directory containing VTKConfig.cmake")
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "C:/Build/PCL/x64/pcl-1.8.1rc1")
...
list(APPEND PCL_DEFINITIONS "  -D__SSSE3__ -D__SSE2__ -D__SSE__")
